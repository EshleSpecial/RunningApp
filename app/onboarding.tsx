        ...
        <Surface style={styles.card} elevation={2}>
          ...
          {step === 2 && (
            <View>
              ...
              <Text style={styles.stepDesc}>
                Rate any pain or discomfort on a scale of 1–10. This helps calibrate your starting plan.
              </Text>
              ...
              {painLevel >= 7 && (
                <Text style={styles.highPainWarning}>
                  ⚠️ High pain detected. Your plan will start conservatively with more cross-training.
                  Please consult a doctor or PT before beginning.
                </Text>
              )}
            </View>
          )}
            ...
            <View>
              ...
              {prefersTreadmill && (
                <Text style={styles.treadmillNote}>
                  🏃 Your workouts will include treadmill speed & incline recommendations.
                </Text>
              )}
            </View>
          )}
          ...
          {step === 5 && (
            <View>
              ...
              <Text style={styles.stepDesc}>
                How hilly is your race course? Your plan will include terrain-specific training for hilly races.
              </Text>
              <View style={styles.courseGrid}>
                {([
                  { value: 'flat',      label: '⬜ Flat',        desc: 'Mostly flat — no significant hills' },
                  { value: 'rolling',   label: '〰️ Rolling',    desc: 'Gentle undulation, a few hills' },
                  { value: 'hilly',     label: '⛰️ Hilly',       desc: 'Significant elevation, frequent climbs' },
                  { value: 'very_hilly',label: '🏔️ Very Hilly', desc: 'Challenging elevation, steep climbs' },
                ] as const).map(opt => (
                  <Button
                    key={opt.value}
              ...
              {(courseDifficulty === 'hilly' || courseDifficulty === 'very_hilly') && (
                <Surface style={styles.hillNote} elevation={0}>
                  <Text style={styles.hillNoteText}>
                    ⛰️ Hill training will be added to your mid-week workouts to prepare for your course.
                  </Text>
                </Surface>
              )}
            </View>
          ...
          {step === 6 && (
            <View>
              ...
              <Text style={styles.stepDesc}>
                Pre-filled with typical runDisney dates. Adjust if your registration confirmation shows different dates.
              </Text>
