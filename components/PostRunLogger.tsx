    ...
    <View style={styles.form}>
      ...
      <View style={styles.fieldRow}>
        ...
        <View style={styles.stepper}>
          <TouchableOpacity
            onPress={() => setGels(g => Math.max(0, g - 1))}
          ...
          <TouchableOpacity
            onPress={() => setGels(g => Math.min(10, g + 1))}
            style={styles.stepBtn}
            activeOpacity={0.7}
          >
            <Text style={styles.stepBtnText}>+</Text>
      ...
      <View style={styles.btnRow}>
        <Button mode="outlined" onPress={() => setShowForm(false)} style={styles.btn} labelStyle={styles.btnLabel}>
          Skip
        </Button>
        <Button
          mode="contained"
